...
import new3 from '../assets/new/3.jpeg';
import new4 from '../assets/new/4.jpeg';
...
import adapted1 from '../assets/adapted/1.jpeg';
import adapted2 from '../assets/adapted/2.jpeg';
import adapted3 from '../assets/adapted/3.jpeg';
import adapted4 from '../assets/adapted/4.jpeg';
import adapted5 from '../assets/adapted/5.jpeg';

import tips1 from '../assets/tips/1.jpeg';
import tips2 from '../assets/tips/2.jpeg';
import tips3 from '../assets/tips/3.jpeg';
      ...
      case 'info':
        return (
          <div className={styles.sectionContent}>
            ...
            <p>Pero lo que a veces no se ve es el impacto emocional de este proceso. Llegar a una ciudad nueva no solo implica cambiar de ambiente, sino también adaptarse a una cultura diferente.</p>
        ...
        return (
          <div className={styles.sectionContent}>
            <div style={{ display: 'flex', gap: 20 }}>
              ...
              <img src={adapted1} style={{ maxWidth: '30%', objectFit: 'contain' }} alt="Retos" />
            </div>
            <div style={{ display: 'flex', gap: 10 }}>
              <img src={adapted2}
            ...
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              <img src={adapted3} style={{ maxWidth: '100%', objectFit: 'contain' }} alt="Retos" />
            </div>
            ...
            <div style={{ display: 'flex', gap: 20 }}>
              ...
              <img src={adapted4} style={{ maxWidth: '40%', objectFit: 'contain' }} alt="Retos" />
            </div>
          </div>
        );
      case 'tips':
        return (
          <div className={styles.sectionContent}>
            <div style={{ display: 'flex', justifyContent: 'center' }}>
              ...
              <img src={tips1} style={{ maxWidth: '40%', objectFit: 'contain' }} alt="Retos" />
            </div>
            ...
            <div className={styles.scatteredPhotos}>
              ...
              <img src={tips5} className={styles.photo5} alt="Tip 5" />
              <img src={tips6} className={styles.photo6} alt="Tip 6" />
            </div>
          </div>
